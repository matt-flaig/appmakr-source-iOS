//
//  AppMakrCommentsTableHeaderView.m
//  appbuildr
//
...
@implementation AppMakrCommentsTableFooterView
...
-(void)layoutSubviews
{
   ...
   UIImage *sbImg = [[UIImage imageNamed:@"/socialize_resources/socialize-comment-background-text-input.png"] stretchableImageWithLeftCapWidth:15 topCapHeight:0];

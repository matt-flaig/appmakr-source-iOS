...
@implementation AppMakrTableBGInfoView
...
- (id)initWithFrame:(CGRect)frame bgImageName:(NSString*)bgImageName {
    ...
    if (self) {
		...
		UIImage *noActivityImage = [UIImage imageNamed:bgImageName/*@"socialize_resources/socialize-noactivity-icon.png"*/];

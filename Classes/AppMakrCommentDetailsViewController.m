//
//  AppmakrCommentDetailsViewController.m
//  appbuildr
//
...
@interface AppmakrCommentDetailsViewController()

    @property(nonatomic, retain) AppMakrURLDownload* profileImageDownloader;
...
@implementation AppmakrCommentDetailsViewController
...
-(void) showComment
{   
    AppMakrHtmlPageCreator* htmlCreator = [[AppMakrHtmlPageCreator alloc]init];
...
- (void)viewDidLoad
{
    ...
    {
        profileImageDownloader = [[AppMakrURLDownload alloc] initWithURL:entryComment.userImageURL sender:self 
...
-(IBAction)viewProfileButtonTouched:(id)sender
{
	...
	UIBarButtonItem * backLeftItem = [self initLeftNavigationButtonWithCaption:@"Comment"];

...
#define CalloutMapAnnotationViewBottomShadowBufferSize 1.0f
...
///    # gradient-background-bottom-color: rbg(19, 23, 26)
    color = [UIColor colorWithRed:19/255.0
                                           green:23/255.0
                                            blue:26/255.0
                                           alpha:0.8];
//	/color = [[UIColor blackColor] colorWithAlphaComponent:.6];
	...
	glossRect.size.height = (((rect.size.height - stroke) / 3) );
	glossRect.origin.x = rect.origin.x + stroke / 2;
	glossRect.origin.y += (rect.origin.y + stroke / 3);

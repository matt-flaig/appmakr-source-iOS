//
//  AppMakrPostCommentViewController.m
//  appbuildr
//
...
@interface AppMakrPostCommentViewController ()
...
@implementation AppMakrPostCommentViewController
...
-(void)setShareLocation:(BOOL)enableLocation
{
    ...
    if (enableLocation) 
    {
        ...
        if (![AppMakrNativeLocation applicationIsAuthorizedToUseLocationServices])
        {

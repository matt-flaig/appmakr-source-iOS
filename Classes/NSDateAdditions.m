...
+(NSString*)getTimeElapsedString:(NSDate*)date{
	...
	NSDateComponents *components = [[NSCalendar currentCalendar] components:
									...
									toDate:[NSDate date]
									options:0];
//	NSDateComponents *components = [NSDate differenceInComponents:date];
	DebugLog(@"date difference components minute  %d hour  %d days  %d months  %d "
			 ,components.minute , components.hour, components.day, components.month);

//
//  AppMakrCommentsTableViewCell.m
//  appbuildr
//
...
@implementation AppMakrCommentsTableViewCell
...
-(void)awakeFromNib{
	self.bgImage.image = [[UIImage imageNamed:@"/socialize_resources/comments-cell-bg-borders.png"]  stretchableImageWithLeftCapWidth:0 topCapHeight:1];
}
...
-(void)layoutSubviews{
	...
	CGFloat totalHeightForCell = [AppMakrCommentsTableViewCell getCellHeightForString:mycomment]; 

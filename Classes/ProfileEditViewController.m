...
#import "ProfileEditValueController.h"
...
- (void)viewDidLoad 
{
	...
	editValueViewController = [[ProfileEditValueController alloc] initWithStyle:UITableViewStyleGrouped];
...
-(ProfileEditTableViewCell *)getProfileImageCell
{
	
	static NSString *profileCellIdentifier = @"profile_Image_cell";
    
	ProfileEditTableViewCell *cell =(ProfileEditTableViewCell *) [self.tableView dequeueReusableCellWithIdentifier:profileCellIdentifier];
    
	if (cell == nil) 
	{
		[[NSBundle mainBundle] loadNibNamed:@"ProfileEditTableViewImageCell" owner:self options:nil];
...
-(ProfileEditTableViewCell *)getNormalCell
{
	
	static NSString *CellIdentifier = @"profile_edit_cell";
	
	ProfileEditTableViewCell *cell =(ProfileEditTableViewCell *) [self.tableView dequeueReusableCellWithIdentifier:CellIdentifier];
	
	if (cell == nil) 
	{
		[[NSBundle mainBundle] loadNibNamed:@"ProfileEditTableViewCell" owner:self options:nil];
		cell = profileEditViewCell;
		self.profileEditViewCell = nil;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	ProfileEditTableViewCell *cell = nil;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath 
{
	...
	ProfileEditTableViewCell *cell =(ProfileEditTableViewCell *) [tableView cellForRowAtIndexPath:indexPath];
	cell.selected = NO;
	if (indexPath.section ==0) 
	{
